...
// this test simply tries to find word ladders from two words that contain leading and trailling whitespace,
// this behaviour should result in no ladders as this is impossible behaviour.
...
TEST_CASE("white space leading or trailing") {
// testing the naive and optimal solution on a small lexicon that only contains a few possible paths
    auto const english_lexicon = ::word_ladder::read_lexicon("./english.txt");
    auto const ladders_efficient = ::word_ladder::generate("   word   ", " play    ", english_lexicon);
// NOT MADE CONST ON PURPOSE TO TEST THE TEST METHOD ITSELF
    auto ladders_correct = ::word_ladder_slow::generate_accurate("   word   ", " play    ", english_lexicon);
